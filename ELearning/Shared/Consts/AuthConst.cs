namespace Share.Consts
{
    public static class AuthConst
    {
        ...
        public static class AppExamStudent
        {
            public const int JOIN = 1206;
        }
        ...
        public static class AppGroupStudent
        {
            public const int JOIN = 1706;
        }
        ...
        public static class AppResult
        {
            ...
            public const int VIEW_DETAIL = 2102;
        }
