                ...
                <li>
                    <a class="d-flex text-dark py-2" href="javascript:void(0)">
                        <div class="flex-shrink-0 mx-3">
                            <img class="img-avatar img-avatar48" src="./public/media/avatars/${notification.avatar
                    }" alt="">
                        </div>
                        <div class="flex-grow-1 fs-sm pe-2">
                            <div class="truncate truncate--3"><span class="fw-semibold">${notification.hoten
                    }</span> đã gửi một thông báo đến học phần <span class="fw-semibold">${notification.tenmonhoc + " - " + notification.tennhom
                    }</span>: ${notification.noidung}${notification.noidung.endsWith(".") ? "" : "."
                    }</div>
                            <div class="text-muted">${displayDate || notification.thoigiantao
                    }</div>
                        </div>
                    </a>
                </li>
